      ...
      {isCartOpen && (
        <>
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/50 z-50 overscroll-y-contain"
            onClick={closeCart}
          />
              ...
              {isLoading ? (
                ...
                items.map((item: any) => {
                  ...
                  return (
                    ...
                    >
                      <div className="relative w-17.5 h-17.5 sm:w-24 sm:h-24 flex-shrink-0 rounded-lg overflow-hidden bg-gray-100">
                        <Image
                          src={imageUrl}
                          alt={product.name}
                          fill
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-[#394426] mb-1">
                          {product.name}
                        </h3>
