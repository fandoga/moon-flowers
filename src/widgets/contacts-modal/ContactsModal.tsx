...
export const ContactsModal = ({ isOpen, onClose }: ContactsModalProps) => {
  ...
  const handleChange = (
    ...
    const newValue = name === "phone" ? applyPhoneMask(value) : value;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onClose(); // правильное закрытие модалки
    } catch (error) {
        ...
        <div className="p-6 md:p-8">
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-[#394426] mb-3">Адрес</h3>
              ...
              <div>
                ...
                <Link
                  className="pt-4 w-fit flex gap-2 items-center"
                  href={"https://max.ru/id165113649438_bot"}
                >
                  <h3 className="text-md font-bold text-[#277DF5] mb-2">
                    Написать в Max
                  </h3>
                  <Image
