...
const Stats = () => {
  ...
  return (
    <section className="relative h-[700px] overflow-hidden sm:h-[600px] w-[100vw] ml-[-4.1%] ml-[calc(-50vw+50%)] z-10">
      ...
      >
        <motion.h2 variants={fadeInUp} className="pb-10 sm:pb-0 w-full relative text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-playfair font-normal text-white text-left leading-tight mb-8 md:mb-12 ">
          Ваш сад начинается <span className="absolute top-10 right-4 sm:top-0 sm:right-0 sm:relative italic font-light tracking-[-0.02em]">с доверия</span>
        </motion.h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-10 lg:gap-12 w-full mx-auto sm:mx-0">
          <motion.div variants={fadeInUp} className="backdrop-blur-sm bg-white/10 rounded-2xl p-6 sm:p-10 text-left">
            <h3 className="text-3xl md:text-5xl text-white mb-3">c 2016</h3>
            <p className="text-base md:text-lg text-white/90 font-manrope">
              выращиваем растения<br />и зарабатываем ваше доверие
            </p>
          </motion.div>

          <motion.div variants={fadeInUp} className="backdrop-blur-sm bg-white/10 rounded-2xl p-6 sm:p-10 text-left">
            <h3 className="text-3xl md:text-5xl text-white mb-3">100 000+</h3>
            <p className="text-base md:text-lg text-white/90 font-manrope">
          ...
          <motion.div variants={fadeInUp} className="backdrop-blur-sm bg-white/10 rounded-2xl p-6 sm:p-10 text-left">
            <h3 className="text-3xl md:text-5xl text-white mb-3">каждый</h3>
            <p className="text-base md:text-lg text-white/90 font-manrope">
