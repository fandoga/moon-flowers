  ...
  return (
    <section className="pt-15 pb-5 sm:pt-30 sm:pb-20 bg-[#F8F9FB]">
      <div className="container mx-auto">
        ...
        >
          <span className="font-playfair italic font-normal text-[clamp(32px,8vw,70px)] leading-[1.64] tracking-[-0.02em] text-[#394426]">
            Специальные{' '}
          </span>
          <span className="font-manrope font-semibold text-[clamp(28px,7vw,61.61px)] leading-[1.64] text-[#394426]">
            предложения
          </span>
        </motion.h2>
        ...
        >
          <motion.div variants={itemVariants} className="text-left">
            <h3 className="font-manrope font-normal text-[clamp(20px,5vw,36px)] leading-none text-[#394426] mb-3 md:mb-4">
              Гарантия<br className="hidden sm:block" /> приживаемости
            </h3>
            <p className="font-manrope font-normal text-[clamp(14px,3vw,20px)] leading-[1.2] text-[#394426]">
