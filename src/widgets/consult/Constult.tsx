  ...
  return (
    <section className="relative py-16 md:py-24 bg-[#F8F9FB] overflow-hidden">
      ...
      >
        <motion.div
          variants={fadeInUp}
          className="flex flex-col items-center text-center md:text-left md:flex-row md:items-start md:justify-evenly gap-6 md:gap-10 mb-16 md:mb-20"
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-4xl font-bold text-[#394426] leading-tight max-w-3xl">
          ...
          <div className="flex flex-col items-start md:items-end gap-2 flex-1">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-[#394426] mx-auto sm:mr-10 text-white font-manrope font-medium text-base text-[12px] sm:text-xl px-8 sm:px-7 py-3.5 sm:py-4.5 rounded-lg hover:bg-[#102902] transition-colors duration-300 whitespace-nowrap cursor-pointer"
            >
              Заказать обратный звонок
            </motion.button>
            <p className="text-md text-black mt-4 text-center max-w-[450px]">
        ...
        <motion.div variants={fadeInUp} className="mb-16 md:mb-20">
          <h3 className="text-[28px] sm:text-4xl md:text-5xl text-[#394426] font-bold mb-8 md:mb-10">
            Мы создаём{" "}
            <span className="italic ml-0 sm:ml-10 font-normal tracking-[-0.02em]">
              зелёную среду
            </span>
          ...
          >
            <h4 className="text-2xl md:text-3xl font-bold text-[#394426] mb-4">
            ...
            <Link href={"/catalog"}>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="mt-6 sm:mt-15 bg-[#394426] text-white text-xs sm:text-xl px-4 mb-4 sm:px-10 py-3 sm:py-4.5 rounded-lg hover:bg-[#102902] transition-colors duration-300 cursor-pointer"
              >
                Подобрать растение
              </motion.button>
            </Link>
          ...
          >
            <h4 className="text-2xl md:text-3xl font-playfair font-bold text-[#394426] mb-4">
            ...
            <Link href={"/catalog"}>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="mt-6 sm:mt-15 text-xs bg-[#394426] text-white text-base sm:text-xl px-8 mb-4 sm:px-10 py-3.5 sm:py-4.5 rounded-lg hover:bg-[#102902] transition-colors duration-300 cursor-pointer"
              >
                Подобрать растение
              </motion.button>
            </Link>
