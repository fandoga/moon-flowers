...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Контакты питомника Клевер Казань',
    description: 'г. Казань, Мамадышский тракт, 58 | пос. Залесный, ул. Залесная, 58. Звоните: +7 (843) 240-90-55',
      ...
      <div className="container mx-auto max-w-[1440px]">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          <div>
            ...
            <p className="text-lg text-gray-700">+7 (843) 240-90-53<br />+7 (966) 240-90-55</p>
